...
with left:
    ...
    encoded_text = urllib.parse.quote_plus(st.session_state.display_text.replace('\n', ' '))
    ...
    # 러시아어 텍스트 하이라이팅 출력 (강세가 없는 원본 텍스트 사용)
